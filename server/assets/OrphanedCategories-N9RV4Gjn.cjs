...
//#region src/views/contents/docList/OrphanedCategories.vue
var _sfc_main = {
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
	...
	_push(`<!--[--><p data-v-690d9b33>`);
	_push((0, require__plugin_vue_export_helper.server_renderer_exports.ssrRenderComponent)(_component_i18next, { translation: _ctx.$t("views.orphaned_categories.description") }, {
		link: (0, require__plugin_vue_export_helper.vue_exports.withCtx)((_, _push, _parent, _scopeId) => {
			if (_push) _push((0, require__plugin_vue_export_helper.server_renderer_exports.ssrRenderComponent)(_component_NuxtLink, { to: _ctx.doc_action_link("분류:분류", "w") }, {
				default: (0, require__plugin_vue_export_helper.vue_exports.withCtx)((_, _push, _parent, _scopeId) => {
					if (_push) _push(`${(0, require__plugin_vue_export_helper.server_renderer_exports.ssrInterpolate)(_ctx.$t("namespaces.분류"))}:${(0, require__plugin_vue_export_helper.server_renderer_exports.ssrInterpolate)(_ctx.$t("namespaces.분류"))}`);
					else return [(0, require__plugin_vue_export_helper.vue_exports.createTextVNode)((0, require__plugin_vue_export_helper.vue_exports.toDisplayString)(_ctx.$t("namespaces.분류")) + ":" + (0, require__plugin_vue_export_helper.vue_exports.toDisplayString)(_ctx.$t("namespaces.분류")), 1)];
				}),
				_: 1
			}, _parent, _scopeId));
			else return [(0, require__plugin_vue_export_helper.vue_exports.createVNode)(_component_NuxtLink, { to: _ctx.doc_action_link("분류:분류", "w") }, {
				default: (0, require__plugin_vue_export_helper.vue_exports.withCtx)(() => [(0, require__plugin_vue_export_helper.vue_exports.createTextVNode)((0, require__plugin_vue_export_helper.vue_exports.toDisplayString)(_ctx.$t("namespaces.분류")) + ":" + (0, require__plugin_vue_export_helper.vue_exports.toDisplayString)(_ctx.$t("namespaces.분류")), 1)]),
				_: 1
			}, 8, ["to"])];
		}),
		_: 1
	}, _parent));
	_push(`</p><p data-v-690d9b33>${(0, require__plugin_vue_export_helper.server_renderer_exports.ssrInterpolate)(_ctx.$t("views.needed_pages.updated_per_day"))}</p>`);
...
var OrphanedCategories_default = /*#__PURE__*/ require__plugin_vue_export_helper._plugin_vue_export_helper_default(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-690d9b33"]]);
//#endregion
exports.default = OrphanedCategories_default;
