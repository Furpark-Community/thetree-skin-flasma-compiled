...
cs.get.hwb = function(string) {
	if (!string) return null;
	const match = string.match(/^hwb\(\s*([+-]?\d{0,3}(?:\.\d+)?)(?:deg)?\s*[\s,]\s*([+-]?[\d.]+)%\s*[\s,]\s*([+-]?[\d.]+)%\s*(?:[\s,]\s*([+-]?(?=\.\d|\d)(?:0|[1-9]\d*)?(?:\.\d*)?(?:[eE][+-]?\d+)?)\s*)?\)$/);
	if (match) {
		const alpha = Number.parseFloat(match[4]);
		return [
			(Number.parseFloat(match[1]) % 360 + 360) % 360,
...
//#endregion
//#region src/views/contents/member/login.vue
var _sfc_main = {
	...
	computed: { externalProviders() {
		return this.data.externalProviders?.map((a) => {
			const buttonHoverColor = a.buttonColor && Color(a.buttonColor).darken(.1).hex();
			const darkButtonHoverColor = a.darkButtonColor && Color(a.darkButtonColor).lighten(.1).hex();
			return {
				...a,
				buttonHoverColor,
	...
	methods: {
		...
		async passkeyLogin(auto = false) {
			...
			let asseResp;
			try {
				asseResp = await require_esm.startAuthentication({
					optionsJSON: this.data.passkeyData,
			...
			await this.internalRequestAndProcess("/member/login", {
				...
				body: JSON.stringify({
					challenge: asseResp,
					autologin: this.autologin ? "Y" : void 0,
		...
		default: (0, require__plugin_vue_export_helper.vue_exports.withCtx)((_, _push, _parent, _scopeId) => {
			if (_push) {
				if (!_ctx.data.disableInternal) {
					...
					_push((0, require__plugin_vue_export_helper.server_renderer_exports.ssrRenderComponent)(_component_FlexFormBlock, { flexStart: "" }, {
						default: (0, require__plugin_vue_export_helper.vue_exports.withCtx)((_, _push, _parent, _scopeId) => {
							if (_push) _push((0, require__plugin_vue_export_helper.server_renderer_exports.ssrRenderComponent)(_component_NuxtLink, { to: "/member/recover_password" }, {
								default: (0, require__plugin_vue_export_helper.vue_exports.withCtx)((_, _push, _parent, _scopeId) => {
									if (_push) _push(`${(0, require__plugin_vue_export_helper.server_renderer_exports.ssrInterpolate)(_ctx.$t("views.login.forgot_password"))}`);
									else return [(0, require__plugin_vue_export_helper.vue_exports.createTextVNode)((0, require__plugin_vue_export_helper.vue_exports.toDisplayString)(_ctx.$t("views.login.forgot_password")), 1)];
								}),
								_: 1
							}, _parent, _scopeId));
							else return [(0, require__plugin_vue_export_helper.vue_exports.createVNode)(_component_NuxtLink, { to: "/member/recover_password" }, {
								default: (0, require__plugin_vue_export_helper.vue_exports.withCtx)(() => [(0, require__plugin_vue_export_helper.vue_exports.createTextVNode)((0, require__plugin_vue_export_helper.vue_exports.toDisplayString)(_ctx.$t("views.login.forgot_password")), 1)]),
								_: 1
							})];
						}),
						_: 1
					...
					_push((0, require__plugin_vue_export_helper.server_renderer_exports.ssrRenderComponent)(_component_FlexFormBlock, {
						...
						buttons: (0, require__plugin_vue_export_helper.vue_exports.withCtx)((_, _push, _parent, _scopeId) => {
							if (_push) {
								if (!_ctx.data.disableSignup) _push((0, require__plugin_vue_export_helper.server_renderer_exports.ssrRenderComponent)(_component_GeneralButton, { href: "/member/signup" }, {
									default: (0, require__plugin_vue_export_helper.vue_exports.withCtx)((_, _push, _parent, _scopeId) => {
										if (_push) _push(`${(0, require__plugin_vue_export_helper.server_renderer_exports.ssrInterpolate)(_ctx.$t("views.login.signup"))}`);
										else return [(0, require__plugin_vue_export_helper.vue_exports.createTextVNode)((0, require__plugin_vue_export_helper.vue_exports.toDisplayString)(_ctx.$t("views.login.signup")), 1)];
									}),
									_: 1
								}, _parent, _scopeId));
								else _push(`<!---->`);
								_push((0, require__plugin_vue_export_helper.server_renderer_exports.ssrRenderComponent)(_component_GeneralButton, {
									...
									default: (0, require__plugin_vue_export_helper.vue_exports.withCtx)((_, _push, _parent, _scopeId) => {
										if (_push) _push(`${(0, require__plugin_vue_export_helper.server_renderer_exports.ssrInterpolate)(_ctx.$t("views.login.submit"))}`);
										else return [(0, require__plugin_vue_export_helper.vue_exports.createTextVNode)((0, require__plugin_vue_export_helper.vue_exports.toDisplayString)(_ctx.$t("views.login.submit")), 1)];
									}),
									_: 1
								}, _parent, _scopeId));
							} else return [!_ctx.data.disableSignup ? ((0, require__plugin_vue_export_helper.vue_exports.openBlock)(), (0, require__plugin_vue_export_helper.vue_exports.createBlock)(_component_GeneralButton, {
								key: 0,
								href: "/member/signup"
							}, {
								default: (0, require__plugin_vue_export_helper.vue_exports.withCtx)(() => [(0, require__plugin_vue_export_helper.vue_exports.createTextVNode)((0, require__plugin_vue_export_helper.vue_exports.toDisplayString)(_ctx.$t("views.login.signup")), 1)]),
								_: 1
							})) : (0, require__plugin_vue_export_helper.vue_exports.createCommentVNode)("", true), (0, require__plugin_vue_export_helper.vue_exports.createVNode)(_component_GeneralButton, {
								type: "submit",
								theme: "primary"
							}, {
								default: (0, require__plugin_vue_export_helper.vue_exports.withCtx)(() => [(0, require__plugin_vue_export_helper.vue_exports.createTextVNode)((0, require__plugin_vue_export_helper.vue_exports.toDisplayString)(_ctx.$t("views.login.submit")), 1)]),
								_: 1
							})];
						}),
						default: (0, require__plugin_vue_export_helper.vue_exports.withCtx)((_, _push, _parent, _scopeId) => {
							if (_push) if (!_ctx.data.noAutoLogin) _push((0, require__plugin_vue_export_helper.server_renderer_exports.ssrRenderComponent)(_component_CheckBox, {
								name: "autologin",
								value: "Y",
								modelValue: $data.autologin,
								"onUpdate:modelValue": ($event) => $data.autologin = $event
							}, {
								default: (0, require__plugin_vue_export_helper.vue_exports.withCtx)((_, _push, _parent, _scopeId) => {
									if (_push) _push(`${(0, require__plugin_vue_export_helper.server_renderer_exports.ssrInterpolate)(_ctx.$t("views.login.auto_login"))}`);
									else return [(0, require__plugin_vue_export_helper.vue_exports.createTextVNode)((0, require__plugin_vue_export_helper.vue_exports.toDisplayString)(_ctx.$t("views.login.auto_login")), 1)];
								}),
								_: 1
							}, _parent, _scopeId));
							else _push(`<!---->`);
							else return [!_ctx.data.noAutoLogin ? ((0, require__plugin_vue_export_helper.vue_exports.openBlock)(), (0, require__plugin_vue_export_helper.vue_exports.createBlock)(_component_CheckBox, {
								key: 0,
								name: "autologin",
								value: "Y",
								modelValue: $data.autologin,
								...
								default: (0, require__plugin_vue_export_helper.vue_exports.withCtx)(() => [(0, require__plugin_vue_export_helper.vue_exports.createTextVNode)((0, require__plugin_vue_export_helper.vue_exports.toDisplayString)(_ctx.$t("views.login.auto_login")), 1)]),
								_: 1
							}, 8, ["modelValue", "onUpdate:modelValue"])) : (0, require__plugin_vue_export_helper.vue_exports.createCommentVNode)("", true)];
						}),
						_: 1
					}, _parent, _scopeId));
					_push(`<!--]-->`);
				} else _push(`<!---->`);
				if ($options.externalProviders.length) {
					_push(`<!--[-->`);
					if (!_ctx.data.disableInternal) _push(`<div class="or" data-v-229791f6${_scopeId}>${(0, require__plugin_vue_export_helper.server_renderer_exports.ssrInterpolate)(_ctx.$t("views.login.external_login"))}</div>`);
					else _push(`<!---->`);
					_push(`<div class="external-login-buttons" data-v-229791f6${_scopeId}><!--[-->`);
					(0, require__plugin_vue_export_helper.server_renderer_exports.ssrRenderList)($options.externalProviders, (item) => {
						_push((0, require__plugin_vue_export_helper.server_renderer_exports.ssrRenderComponent)(_component_GeneralButton, {
							block: "",
							class: "external-login-button",
							href: `/member/login/oauth2/${item.name}?redirect=${encodeURIComponent(_ctx.$route.query.redirect)}${$data.autologin ? `&autologin=Y` : ""}`,
							style: {
								"--light-article-background-color": item.buttonColor || void 0,
								"--dark-article-background-color": item.darkButtonColor || void 0,
								"--button-background-hover-color": item.buttonHoverColor || void 0,
								"--button-background-dark-hover-color": item.darkButtonHoverColor || void 0,
								"--light-text-color": item.textColor || void 0,
								"--dark-text-color": item.darkTextColor || void 0
							}
						}, {
							default: (0, require__plugin_vue_export_helper.vue_exports.withCtx)((_, _push, _parent, _scopeId) => {
								if (_push) {
									if (item.logo || item.darkLogo) _push(`<img${(0, require__plugin_vue_export_helper.server_renderer_exports.ssrRenderAttr)("src", _ctx.$store.state.isDark && item.darkLogo || item.logo || item.darkLogo)} data-v-229791f6${_scopeId}>`);
									else _push(`<!---->`);
									_push(` ${(0, require__plugin_vue_export_helper.server_renderer_exports.ssrInterpolate)(_ctx.$store.state.isDark && item.darkText || item.text)}`);
								} else return [item.logo || item.darkLogo ? ((0, require__plugin_vue_export_helper.vue_exports.openBlock)(), (0, require__plugin_vue_export_helper.vue_exports.createBlock)("img", {
									key: 0,
									src: _ctx.$store.state.isDark && item.darkLogo || item.logo || item.darkLogo
								}, null, 8, ["src"])) : (0, require__plugin_vue_export_helper.vue_exports.createCommentVNode)("", true), (0, require__plugin_vue_export_helper.vue_exports.createTextVNode)(" " + (0, require__plugin_vue_export_helper.vue_exports.toDisplayString)(_ctx.$store.state.isDark && item.darkText || item.text), 1)];
							}),
							_: 2
						}, _parent, _scopeId));
					});
				...
				_push(`<input type="hidden" name="redirect"${(0, require__plugin_vue_export_helper.server_renderer_exports.ssrRenderAttr)("value", _ctx.$route.query.redirect)} data-v-229791f6${_scopeId}>`);
			} else return [
				!_ctx.data.disableInternal ? ((0, require__plugin_vue_export_helper.vue_exports.openBlock)(), (0, require__plugin_vue_export_helper.vue_exports.createBlock)(require__plugin_vue_export_helper.vue_exports.Fragment, { key: 0 }, [
					...
					(0, require__plugin_vue_export_helper.vue_exports.createVNode)(_component_FlexFormBlock, { flexStart: "" }, {
						default: (0, require__plugin_vue_export_helper.vue_exports.withCtx)(() => [(0, require__plugin_vue_export_helper.vue_exports.createVNode)(_component_NuxtLink, { to: "/member/recover_password" }, {
							default: (0, require__plugin_vue_export_helper.vue_exports.withCtx)(() => [(0, require__plugin_vue_export_helper.vue_exports.createTextVNode)((0, require__plugin_vue_export_helper.vue_exports.toDisplayString)(_ctx.$t("views.login.forgot_password")), 1)]),
							_: 1
						})]),
						_: 1
					...
					(0, require__plugin_vue_export_helper.vue_exports.createVNode)(_component_FlexFormBlock, {
						...
						buttons: (0, require__plugin_vue_export_helper.vue_exports.withCtx)(() => [!_ctx.data.disableSignup ? ((0, require__plugin_vue_export_helper.vue_exports.openBlock)(), (0, require__plugin_vue_export_helper.vue_exports.createBlock)(_component_GeneralButton, {
							key: 0,
							href: "/member/signup"
						}, {
							default: (0, require__plugin_vue_export_helper.vue_exports.withCtx)(() => [(0, require__plugin_vue_export_helper.vue_exports.createTextVNode)((0, require__plugin_vue_export_helper.vue_exports.toDisplayString)(_ctx.$t("views.login.signup")), 1)]),
						...
						default: (0, require__plugin_vue_export_helper.vue_exports.withCtx)(() => [!_ctx.data.noAutoLogin ? ((0, require__plugin_vue_export_helper.vue_exports.openBlock)(), (0, require__plugin_vue_export_helper.vue_exports.createBlock)(_component_CheckBox, {
							key: 0,
							name: "autologin",
							value: "Y",
							modelValue: $data.autologin,
				...
				$options.externalProviders.length ? ((0, require__plugin_vue_export_helper.vue_exports.openBlock)(), (0, require__plugin_vue_export_helper.vue_exports.createBlock)(require__plugin_vue_export_helper.vue_exports.Fragment, { key: 1 }, [!_ctx.data.disableInternal ? ((0, require__plugin_vue_export_helper.vue_exports.openBlock)(), (0, require__plugin_vue_export_helper.vue_exports.createBlock)("div", {
					key: 0,
					class: "or"
				}, (0, require__plugin_vue_export_helper.vue_exports.toDisplayString)(_ctx.$t("views.login.external_login")), 1)) : (0, require__plugin_vue_export_helper.vue_exports.createCommentVNode)("", true), (0, require__plugin_vue_export_helper.vue_exports.createVNode)("div", { class: "external-login-buttons" }, [((0, require__plugin_vue_export_helper.vue_exports.openBlock)(true), (0, require__plugin_vue_export_helper.vue_exports.createBlock)(require__plugin_vue_export_helper.vue_exports.Fragment, null, (0, require__plugin_vue_export_helper.vue_exports.renderList)($options.externalProviders, (item) => {
					return (0, require__plugin_vue_export_helper.vue_exports.openBlock)(), (0, require__plugin_vue_export_helper.vue_exports.createBlock)(_component_GeneralButton, {
						block: "",
						class: "external-login-button",
						href: `/member/login/oauth2/${item.name}?redirect=${encodeURIComponent(_ctx.$route.query.redirect)}${$data.autologin ? `&autologin=Y` : ""}`,
						style: {
						...
						default: (0, require__plugin_vue_export_helper.vue_exports.withCtx)(() => [item.logo || item.darkLogo ? ((0, require__plugin_vue_export_helper.vue_exports.openBlock)(), (0, require__plugin_vue_export_helper.vue_exports.createBlock)("img", {
							key: 0,
							src: _ctx.$store.state.isDark && item.darkLogo || item.logo || item.darkLogo
						}, null, 8, ["src"])) : (0, require__plugin_vue_export_helper.vue_exports.createCommentVNode)("", true), (0, require__plugin_vue_export_helper.vue_exports.createTextVNode)(" " + (0, require__plugin_vue_export_helper.vue_exports.toDisplayString)(_ctx.$store.state.isDark && item.darkText || item.text), 1)]),
						_: 2
				...
				(0, require__plugin_vue_export_helper.vue_exports.createVNode)("input", {
					type: "hidden",
					name: "redirect",
					value: _ctx.$route.query.redirect
				}, null, 8, ["value"])
			];
		}),
		_: 1
...
_sfc_main.setup = (props, ctx) => {
	...
	(ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("src/views/contents/member/login.vue");
	return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
var login_default = /*#__PURE__*/ require__plugin_vue_export_helper._plugin_vue_export_helper_default(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-229791f6"]]);
//#endregion
exports.default = login_default;
